                    ...
                    @if (!empty(Cart::getContent()->count()))
                        <div class="row">
                            <div class="col-lg-9">
                                <form action="{{ url('update_cart') }}" method="post">
                                    ...
                                    <div class="cart-bottom">
                                        ...
                                        <button type="submit" href="#" class="btn btn-outline-dark-2"><span>UPDATE CART</span><i
                            ...
                            <aside class="col-lg-3">
                                ...
                                <a href="{{ url('') }}" class="btn btn-outline-dark-2 btn-block mb-3"><span>CONTINUE SHOPPING</span><i
