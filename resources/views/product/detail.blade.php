                            ...
                            <div class="product-gallery">
                                <figure class="product-main-image">
                                    ...
                                    @if (!empty($getProductImage) && !empty($getProductImage->getLogo()))
                                        <img id="product-zoom" src="{{ $getProductImage->getLogo() }}" data-zoom-image="{{ $getProductImage->getLogo() }}"
                                            alt="product image">
                        ...
                        <div class="col-md-6">
                            <div class="product-details">
                                ...
                                <div class="ratings-container">
                                    ...
                                    <a class="ratings-text" href="#product-review-link" id="review-link">({{ $getProduct->getTotalReview() }} Reviews
                                        )</a>
                                ...
                                <form action="{{ url('product/add-to-cart') }}" method="POST">
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        ...
                                        <div class="product-details-quantity">
                                            <input type="number" id="qty" class="form-control" value="1" min="1" max="100"
                                                name="qty" required step="1" data-decimals="0" required>
                                    ...
                                    <div class="product-details-action">
                                        ...
                                        <div class="details-action-wrapper">
                                            @if (!empty(Auth::check()))
                                                <a href="javascript:;"
                                                    class="add_to_wishlist add_to_wishlist{{ $getProduct->id }} btn-product btn-wishlist {{ !empty($getProduct->checkWishlist($getProduct->id)) ? 'btn-wishlist-add' : '' }} "
                                                    title="Wishlist" id="{{ $getProduct->id }}"><span>Add to
                                                        Wishlist</span></a>
                                            @else
                                                <a href="#signin-modal" data-toggle="modal" class="btn-product btn-wishlist" title="Wishlist"><span>Add to
                                                        Wishlist</span></a>
                                            @endif
                                ...
                                <div class="product-details-footer">
                                    <div class="product-cat">
                                        ...
                                        <a class="breadcrumb-item"><a
                                                href="{{ url($getProduct->getCategory->slug) }}">{{ $getProduct->getCategory->name }}</a></a>,
                                        <a class="breadcrumb-item"><a
                                                href="{{ url($getProduct->getCategory->slug . '/' . $getProduct->getSubCategory->slug) }}">{{ $getProduct->getSubCategory->name }}</a>
                                        </a>
                                    </div><!-- End .product-cat -->
                    ...
                    <ul class="nav nav-pills justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="product-review-link" data-toggle="tab" href="#product-review-tab" role="tab"
                                aria-controls="product-review-tab" aria-selected="false">Reviews ({{ $getProduct->getTotalReview() }})</a>
                        </li>
                    </ul>
                </div><!-- End .container -->
