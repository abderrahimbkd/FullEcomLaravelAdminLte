        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    @if (!empty($getSubCategory))
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ url($getCategory->slug) }}">{{ $getCategory->name }}</a>
                        </li>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div style="text-align: center">
                            <a href="javascript:;" @if (empty($page)) style="display: none" @endif data-page={{ $page }}
                                class="btn btn-primary LoadMore">Load
                                More</a>
                        </div>
                                        ...
                                        <div class="filter-colors">
                                            @foreach ($getColor as $f_color)
                                                <a href="javascript:;" class="ChangeColor" data-val='0' id="{{ $f_color->id }}"
                                                    style="background: {{ $f_color->code }};"><span class="sr-only">{{ $f_color->name }}</span></a>
                                            @endforeach
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="filter-items">
                                            @foreach ($getBrand as $f_brand)
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input ChangeBrand" value="{{ $f_brand->id }}"
                                                            id="brand-{{ $f_brand->id }}">
                                                        <label class="custom-control-label"
