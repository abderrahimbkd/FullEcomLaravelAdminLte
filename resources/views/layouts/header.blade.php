                ...
                <ul class="top-menu">
                    <li>
                        ...
                        <ul>
                            ...
                            @if (!empty(Auth::check()))
                                <li><a href="{{ url('my_wishlist') }}"><i class="icon-heart-o"></i>My Wishlist <span>(3)</span></a></li>
                            @else
        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="{{ url('') }}" class="logo">
                    <img src= "{{ url('front/assets/images/logo.png') }}" width="105" height="25">
                </a>
                                        ...
                                        <div class="menu-col">
                                            <div class="row">
                                                ...
                                                @foreach ($getCategoryHeader as $value_c_h)
                                                    @if (!empty($value_c_h->getSubcategory->count()))
                                                        <div class="col-md-4" style='margin_bottom:20px'>
                                                            <a href="{{ url($value_c_h->slug) }}"
                                                                class="menu-title">{{ $value_c_h->name }}</a><!-- End .menu-title -->
                                                            <ul>
                                                                @foreach ($value_c_h->getSubCategory as $value_h_sub)
                                                                    <li><a
                                                                            href="{{ url($value_c_h->slug . '/' . $value_h_sub->slug) }}">{{ $value_h_sub->name }}</a>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
                                                        </div><!-- End .col-md-6 -->
                    ...
                    @if (!empty(Cart::getContent()->count()))
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-cart-products">
                                @foreach (Cart::getContent() as $hearder_cart)
                                    @php
                                        $getCartProduct = App\Models\ProductModel::getSingle($hearder_cart->id);
                                        ...
                                        <div class="product">
                                            <div class="product-cart-details">
                                                ...
                                                <span class="cart-product-info">
                                                    <span class="cart-product-qty">{{ $hearder_cart->quantity }}</span>
                                                    x ${{ number_format($hearder_cart->price, 2) }}
                                                </span>
