                        ...
                        <div class="col-md-8 col-lg-9">
                            <div class="tab-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-3" style="margin-bottom: 20px">
                                        <div class="box-btn">
                                            <div style="font-size: 20px;font-weight:bold;">{{ $TodayTotalOrder }}</div>
                                    ...
                                    <div class="col-md-3" style="margin-bottom: 20px">
                                        <div class="box-btn">
                                            ...
                                            <div style="font-size: 16px">Inprogress Orders</div>
                                        </div>
                                    </div>
                                    <div class="col-md-3" style="margin-bottom: 20px">
                                        <div class="box-btn">
                                    ...
                                    <div class="col-md-3">
                                        <div class="box-btn">
                                            ...
                                            <div style="font-size: 16px">Canelled Orders</div>
                                        </div>
                                    </div>
