                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" style="display: block" name="is_home" {{ !empty($getRecord->is_home) ? 'checked' : '' }}>
                                    </div>
                                    <hr />
                                    <div class="form-group">
                                        <label>Menu <span style="color: red"></span></label>
                                        <input type="checkbox" style="display: block" name="is_menu" {{ !empty($getRecord->is_menu) ? 'checked' : '' }}>
                                    </div>
                                    <hr />
                                    <div class="form-group">
